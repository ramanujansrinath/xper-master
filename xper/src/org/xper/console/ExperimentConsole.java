...
public class ExperimentConsole extends JFrame implements
    ...
    private void initComponents() {
        ...
        trialStatPanel.add(completeTrialCount,
        		new GridBagConstraints(1,0,1,1,0.0,0.0,GridBagConstraints.LINE_END,GridBagConstraints.NONE,new Insets(0,0,0,0),0,0));
//        trialStatPanel.add(new JLabel("Target Wrong"),
//        		new GridBagConstraints(2,0,1,1,0.0,0.0,GridBagConstraints.LINE_END,GridBagConstraints.NONE,new Insets(0,10,0,0),0,0));   
//        targetWrongCount = new JLabel("0");
//        trialStatPanel.add(targetWrongCount,
//        		new GridBagConstraints(3,0,1,1,0.0,0.0,GridBagConstraints.LINE_END,GridBagConstraints.NONE,new Insets(0,0,0,0),0,0));
        ...
        trialStatPanel.add(breakTrialCount,
        		new GridBagConstraints(1,1,1,1,0.0,0.0,GridBagConstraints.LINE_END,GridBagConstraints.NONE,new Insets(0,0,0,0),0,0));
//        trialStatPanel.add(new JLabel("Target Break"),
//        		new GridBagConstraints(2,1,1,1,0.0,0.0,GridBagConstraints.LINE_END,GridBagConstraints.NONE,new Insets(0,10,0,0),0,0)); 
//        targetBreakCount = new JLabel("0");
//        trialStatPanel.add(targetBreakCount,
//        		new GridBagConstraints(3,1,1,1,0.0,0.0,GridBagConstraints.LINE_END,GridBagConstraints.NONE,new Insets(0,0,0,0),0,0));
        ...
        trialStatPanel.add(failTrialCount,
        		new GridBagConstraints(1,2,1,1,0.0,0.0,GridBagConstraints.LINE_END,GridBagConstraints.NONE,new Insets(0,0,0,0),0,0));
//        trialStatPanel.add(new JLabel("Target Fail"),
//        		new GridBagConstraints(2,2,1,1,0.0,0.0,GridBagConstraints.LINE_END,GridBagConstraints.NONE,new Insets(0,10,0,0),0,0)); 
//        targetFailCount = new JLabel("0");
//        trialStatPanel.add(targetFailCount,
...
//        targetWrongCount.setHorizontalAlignment(SwingConstants.RIGHT);
//        targetWrongCount.setPreferredSize(new Dimension(50,20));
//        targetBreakCount.setHorizontalAlignment(SwingConstants.RIGHT);
//        targetFailCount.setHorizontalAlignment(SwingConstants.RIGHT);
	...
	void updateStatistics() {
		...
		this.completeTrialCount.setText(StringUtil.format(stat.getCompleteTrials(),
				0));
		this.breakTrialCount.setText(StringUtil.format(stat.getBrokenTrials(), 0));
		this.failTrialCount.setText(StringUtil.format(stat.getFailedTrials(), 0));
		
//		this.targetBreakCount.setText(StringUtil.format(stat.getTargetBreak(), 0));
//		this.targetFailCount.setText(StringUtil.format(stat.getTargetFail(), 0));
//		this.targetWrongCount.setText(StringUtil.format(stat.getTargetWrong(), 0));
	}
    ...
    //private JLabel targetFailCount;
    //private JLabel targetBreakCount;
    //private JLabel targetWrongCount;
